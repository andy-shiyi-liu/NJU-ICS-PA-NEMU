...
instr_func opcode_entry[256] = {
    ...
    /* 0x08 - 0x0b*/ or_r2rm_b, or_r2rm_v, or_rm2r_b, inv, 
    /* 0x0c - 0x0f*/ or_i2a_b, or_i2a_v, inv, opcode_2_byte, 
    /* 0x10 - 0x13*/ adc_r2rm_b, adc_r2rm_v, inv, inv, 
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v/*lea_rm2r_v*/, mov_rm2s_w, inv, 
...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, and_i2rm_b, inv, inv, cmp_i2rm_b};
...
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, not_rm_v, neg_rm_v, mul_rm2a_v, imul_rm2a_v, inv, idiv_rm2a_v};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x80 - 0x83*/ inv, inv, jb_near, jae_near, 
